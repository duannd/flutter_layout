...
class _HomePageState extends State<HomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      //    which causes it to rerun the build method below so that the display can reflect the updated values.
  ...
  Widget build(BuildContext context) {
    ...
    //    so that you can just rebuild anything that needs updating rather than having to individually change instances of widgets.
    return Scaffold(
      appBar: AppBar(
        // Here we take the value from the HomePage object that was created by the App.build method, and use it to set our appbar title.
